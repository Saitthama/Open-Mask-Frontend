...
/// Farbfilter, der das linke Auge ausfüllt. Wird nicht angezeigt, wenn das Auge geschlossen ist.
class LeftEyeColorFilter extends om_color_filter.ColorFilter {
  /// Standard-Konstruktor.
  LeftEyeColorFilter({super.id, required super.meta, super.color})
  ...
  factory LeftEyeColorFilter.fromJSON(final Map<String, dynamic> json) {
    return om_color_filter.ColorFilter.fromJSON(json, LeftEyeColorFilter.new)
  ...
  void apply(
    ...
    FaceContour? faceContour = face.contours[FaceContourType.leftEye];
    if (faceContour == null || (face.leftEyeOpenProbability ?? 1) < 0.05) {
      return;
    }
    final maskPath = Path();
